...
// Login functions (defined in apptwo.js)
window.openLoginModal = openLoginModal;
window.closeLoginModal = closeLoginModal;

// Form functions (defined in apptwo.js)  
window.submitForm = submitForm;
window.resetForm = resetForm;

// Dashboard functions (defined in apptwo.js)
window.showDashboard = showDashboard;
window.filterData = filterData;
window.logout = logout;

// Pagination functions (defined in apptwo.js)
window.goToPreviousPage = goToPreviousPage;
window.goToNextPage = goToNextPage;

// Export functions (defined in apptwo.js)
window.exportToCSV = exportToCSV;

// Settings functions (defined in apptwo.js)
window.handleSanitationChange = handleSanitationChange;

// Feedback functions (defined in apptwo.js)
...
// Location functions (defined in apptwo.js)
window.handleLocationChange = handleLocationChange;

console.log('✅ All apptwo.js functions exposed globally');