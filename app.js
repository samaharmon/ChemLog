...
<head>
    ...
    <script type="module">
        ...
        console.log('Firebase initialized successfully and marked as ready');
    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <form id="loginForm" class="modal-form">
                ...
                <button type="submit" class="login-btn" onclick="handleLoginSubmit()">Login</button>
            </form>
        </div>
    </div>
...
<!-- Feedback Modal -->
<div id="feedbackModal" style="display: none; position: fixed; top: 20%; left: 50%; transform: translateX(-50%); z-index: 9999; padding: 20px; border-radius: 0px; box-shadow: 0 0 10px rgba(0,0,0,0.3); max-width: 400px; text-align: center;">
