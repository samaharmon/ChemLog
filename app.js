...
async function submitFormFirebase() {
    console.log('🔥 Firebase submitForm called'); // Debug log
...
window.submitForm = submitFormFirebase; // Override any other submitForm
window.submitFormFirebase = submitFormFirebase;
